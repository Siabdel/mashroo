...
from django.views.generic.edit import UpdateView as create_updat, CreateView, DeleteView
from django.views.generic.detail import DetailView as list_detail
from django.views.generic import list as list_detail
from django.views.generic import ListView as list_detail
