...
from core.widgets.models import Region
from core.widgets.templatetags.widget import WidgetNode
...
def region(parser, token):
    ...
    try:
        ...
        raise ( template.TemplateSyntaxError, "%r tag requires a single argument".format( token.contents.split()[0]))
