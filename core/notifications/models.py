...
class Signature(models.Model):
    ...
    subscribers = models.ManyToManyField('auth.User',  blank=True, through='Subscription', verbose_name=_('subscribers'))
...
class Subscription(models.Model):
    ...
    signature = models.ForeignKey(Signature, on_delete=models.DO_NOTHING)
...
class Stream(models.Model):
    ...
    """
    slug = models.SlugField(_('slug'), max_length=100, unique=True)
    linked_streams = models.ManyToManyField('self',   blank=True, symmetrical=False, verbose_name=_('linked streams'))
    followers = models.ManyToManyField('auth.User',   verbose_name=_('followers'))
...
class Activity(models.Model):
    ...
    def get_content(self):
        template_name = "notifications/activities/%s.html".format( self.signature)
        if self.template:
...
class Notification(models.Model):
    ...
    signature = models.ForeignKey(Signature, verbose_name=_('signature'), on_delete=models.DO_NOTHING)
