...
from core.profile.models import Service, Fonction
from core.profile.forms import enrich_form
...
def user_list(request, page=0, paginate_by=10, **kwargs):
    ...
    """
    render(request, 'auth/user_list.html', kwargs)
...
def user_detail(request, username, **kwargs):
    ...
    render(request, 'auth.view_user', kwargs)
    """
