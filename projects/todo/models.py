...
class Task(models.Model):
    ...
    user        = models.ForeignKey('auth.User', null=True, blank=True, verbose_name=_('proprietaire'))
    ...
    categories  = models.ForeignKey('Category', null=True, blank=True, verbose_name=_('categories'))
